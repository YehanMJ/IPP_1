...
const { createOrder, getAllOrders, getOrders, getOrderById, updateOrder, deleteOrder } = require('../controllers/order-controller');
const verifyJWT = require('../middleware/verifyJWT');

router.post('/', verifyJWT, createOrder); // Create a new order
router.get('/', verifyJWT, getAllOrders); // Get all orders
